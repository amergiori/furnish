                            ...
                            <div class="module-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="w-100 field-input-cms">
                                            ...
                                            <input type="text" value="{{ $product_item['ptitle'] }}" name="ptitle" id="ptitle" style="width:100%" class="form-control original-text" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                        </div>
                                        ...
                                        <div class="field-input-cms w-100">
                                            ...
                                            <input type="text" value="{{ $product_item['purl'] }}" name="purl" id="purl" size="120" class="form-control target-text mw-100" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                        </div>
                                        ...
                                        <div class="w-100 field-input-cms">
                                            ...
                                            <input type="number" step="1" min="1" value="{{ $product_item['stock'] }}" name="stock" style="width:100%" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                        </div>
                                        ...
                                        <div class="field-input-cms w-100">
                                            ...
                                            <input type="number" step="0.01" min="0" value="{{ $product_item['price'] }}" name="price" id="price" size="120" class="form-control mw-100" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                        </div>
                                        ...
                                        <div class="input-group mb-3 field-input-cms">
                                            <div class="form-group">
                                                <img width="80" src="{{ asset('images/products/' . $product_item['pimage']) }}" >
                                            </div>
                                                <div class="w-100 field-input-cms">
                                                    <label for="pimage" class="input-group-text"><span class="text-danger">*</span><b> Change Image:</b></label>        
                                                </div>
                                                <div class="input-group mb-3">
