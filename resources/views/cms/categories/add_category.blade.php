                                ...
                                <form action="{{ url('cms/categories') }}" method="POST" novalidate="novalidate" autocomplete="off" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                            <div class="w-100 field-input-cms">
                                                ...
                                                <input type="text" value="{{ old('title') }}" name="title" id="title" style="width:100%" class="form-control original-text" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                            </div>
